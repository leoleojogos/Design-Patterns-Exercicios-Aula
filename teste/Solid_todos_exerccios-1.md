...
1 - Pois a classe RelatorioVendas está realizando mais de uma função.
2 - Gerar Relatorio, salvar relatorio e enviar Relatorio pelo email
3 - 
...
R: Realizando mais de uma função
...
R:
public class CalculadoraFrete {
   public class  TipoEntrega(String tipoEntrega){
